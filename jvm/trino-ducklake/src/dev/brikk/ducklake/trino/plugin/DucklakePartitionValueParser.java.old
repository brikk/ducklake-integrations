 ...
 */
final class DucklakePartitionValueParser
{
    private DucklakePartitionValueParser() {}

    static Object parseIdentity(Type type, String value)
    {
        if (type.equals(VARCHAR) || type instanceof VarcharType) {
