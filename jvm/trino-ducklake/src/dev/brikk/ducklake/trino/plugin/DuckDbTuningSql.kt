 ...
 * mandatory settings we always apply (`http_keep_alive`, `http_retries`).
 * Executors call [applyDirect] (in-process) or [statements] (for
 * Quack, which ships each via the `quack_query_by_name` wrapper).
 */
