 ...
 * `ducklake.execution-engine` catalog property; consumed by
 * [DucklakeDuckDbExecutorFactory] to pick the concrete
 * [DucklakeDuckDbExecutor] implementation per split.
 */
enum class DucklakeExecutionEngine {
