 ...
 * processor provider. Today the only table function is `system.lance_vector_search`.
 */
class DucklakeFunctionProvider @Inject constructor(
    ...
    override fun getTableFunctionProcessorProvider(
        ...
        if (functionHandle is LanceVectorSearchFunctionHandle) {
            return ClassLoaderSafeTableFunctionProcessorProvider(
                    LanceVectorSearchProcessorProvider(executorFactory),
