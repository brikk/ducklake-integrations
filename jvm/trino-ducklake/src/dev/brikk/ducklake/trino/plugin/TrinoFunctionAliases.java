...
final class TrinoFunctionAliases
{
     ...
     */
    static void loadInProcess(Connection connection, String path) throws SQLException
    {
     ...
     */
    static void loadServerSide(QuackStatementForwarder forwarder, String path) throws SQLException
    {
     ...
     */
    @FunctionalInterface
    interface QuackStatementForwarder
    {
