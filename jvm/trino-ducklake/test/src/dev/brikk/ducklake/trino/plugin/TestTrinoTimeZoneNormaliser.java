 ...
 */
public class TestTrinoTimeZoneNormaliser
{
    // --- Named IANA zones — pass through unchanged ---------------------------

    @Test
    public void testNamedIanaPassesThrough()
    {
    ...
    @Test
    public void testNamedIanaWithFractionalOffsetPassesThrough()
    {
    ...
    @Test
    public void testUtcAndGmtPassThrough()
    {
    ...
    @Test
    public void testPositiveOffsetGetsInvertedToNegativeEtcGmt()
    {
    ...
    @Test
    public void testNegativeOffsetGetsInvertedToPositiveEtcGmt()
    {
    ...
    @Test
    public void testZeroOffsetTranslatesToEtcGmtZero()
    {
    ...
    @Test
    public void testFractionalPositiveOffsetPassesThroughForDuckDbToReject()
    {
    ...
    @Test
    public void testFractionalNegativeOffsetPassesThrough()
    {
    ...
    @Test
    public void testWrongLengthOffsetShapeDoesNotMatch()
    {
    ...
    @Test
    public void testNonDigitInOffsetShapeDoesNotMatch()
    {
